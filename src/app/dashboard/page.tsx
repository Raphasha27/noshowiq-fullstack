...
export default function Home() {
  ...
  return (
    <main style={{ padding: '0', maxWidth: '1400px', margin: '0 auto', display: 'flex', minHeight: '100vh', flexWrap: 'wrap', backgroundColor: '#f8fafc' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
              ...
              <button className="btn" style={{ justifyContent: 'flex-start', background: activeTab === 'settings' ? '#eff6ff' : 'transparent', color: activeTab === 'settings' ? '#2563eb' : '#334155', fontWeight: 600 }} onClick={() => setActiveTab('settings')}>
      ...
      <section className="main-content" style={{ flex: 1, padding: '32px', minWidth: '320px', backgroundColor: '#f8fafc' }}>
        ...
        {activeTab === 'analytics' && (
           <div className="glass-card" style={{ padding: '24px', background: 'white', border: '1px solid #e2e8f0' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                 <h2 style={{ fontSize: '1.2rem', fontWeight: 700, color: '#0f172a' }}>Advanced Analytics</h2>
                 <button className="btn" style={{ background: '#f1f5f9', color: '#334155', fontSize: '0.85rem' }} onClick={() => showNotification("Downloading Report...")}>
        ...
        {/* Mobile Bottom Navigation */}
         <nav className="mobile-nav" style={{ 
            ...
            <button onClick={() => setActiveTab('settings')} style={{ background: 'none', border: 'none', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px', color: activeTab === 'settings' ? '#2563eb' : '#64748b' }}>
      ...
      {/* Settings View */}
      {activeTab === 'settings' && (
        <div className="glass-card" style={{ padding: '32px', background: 'white', border: '1px solid #e2e8f0', maxWidth: '800px' }}>
          <h2 style={{ fontSize: '1.5rem', fontWeight: 800, color: '#0f172a', marginBottom: '32px' }}>Clinic Settings</h2>
          
          <div style={{ marginBottom: '32px' }}>
            <h3 style={{ fontSize: '1.1rem', fontWeight: 700, marginBottom: '16px' }}>General Preference</h3>
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '16px', borderBottom: '1px solid #f1f5f9' }}>
              <div>
                 ...
                 <div style={{ fontSize: '0.8rem', color: '#64748b' }}>Switch the dashboard to dark theme</div>
              </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', padding: '16px', borderBottom: '1px solid #f1f5f9' }}>
              <div>
                 ...
                 <div style={{ fontSize: '0.8rem', color: '#64748b' }}>Get alerted for high-risk predictions</div>
              </div>
              <div style={{ width: '40px', height: '24px', background: '#2563eb', borderRadius: '12px', position: 'relative' }}>
          ...
          <div style={{ marginBottom: '32px' }}>
            <h3 style={{ fontSize: '1.1rem', fontWeight: 700, marginBottom: '16px' }}>AI Sensitivity</h3>
            <div style={{ padding: '16px', background: '#f8fafc', borderRadius: '12px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
                 <label style={{ fontWeight: 600 }}>Effectiveness Threshold</label>
                 <span style={{ fontWeight: 700, color: '#2563eb' }}>85%</span>
              </div>
              <input type="range" min="0" max="100" defaultValue="85" style={{ width: '100%', accentColor: '#2563eb' }} />
              <div style={{ fontSize: '0.8rem', color: '#64748b', marginTop: '8px' }}>Adjust how aggressive the prediction model should be</div>
            </div>
          </div>

          <button className="btn" style={{ background: '#0f172a', color: 'white', padding: '12px 24px' }} onClick={() => showNotification("Settings Saved!")}>
             Save Changes
          </button>
        </div>
      )}
