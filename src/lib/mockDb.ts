...
let appointments: Appointment[] = [
  {
    ...
    reasoning: ["Strong attendance history", "Confirmed via SMS"],
  },
  {
    id: "2",
    ...
    status: "Confirmed",
    date: new Date().toISOString(),
    reasoning: ["Patient lives nearby", "Routine visit"],
  },
  {
    id: "3",
    patient: "Emma Wilson",
    ...
    status: "Pending",
    date: new Date().toISOString(),
    reasoning: ["New patient", "First appointment"],
  },
  {
    id: "4",
    patient: "Robert Blake",
    time: "11:00 AM",
    risk: 0.78,
    riskLevel: "high",
    type: "X-Ray Review",
    ...
    date: new Date().toISOString(),
    reasoning: ["2 no-shows in last 6 months", "Long lead time (45 days)", "Monday morning slot"],
  },
  {
    id: "5",
    ...
    status: "Confirmed",
    date: new Date().toISOString(),
    reasoning: ["History of late arrivals", "Distance over 10 miles"],
  },
];
